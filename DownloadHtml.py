...
with open("F:\\androidsource\\google-samples\\htmlf.txt", "w") as f:
    b = open("F:\\androidsource\\google-samples\\htmlb.txt", "w")
    b.write(download("https://github.com/googlesamples"))
    res_tr = r'<a href="/googlesamples/(.*?)" itemprop="name codeRepository">'
    ...
    for each in m_num:
        ...
        # else:
        htmlPath = "https://github.com/googlesamples/?page=" + str(each)
        list1.append(htmlPath)
        ...
        for listatr in list1:
            ...
            for line in m_str:
                ...
                #strline = line + "  \n"
                #合成想要的字符串用于下载文件
                strHtml = "git " + "clone " + "https://github.com/googlesamples/" + line + "\n"
                f.write(strHtml)
